...
<div class="navbar navbar-static-top">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a class="brand" href="#">Aplicacion Clientes</a>
      ...
      <div class="nav-collapse collapse pull-right">
        <?php $this->widget('zii.widgets.CMenu',array(
          ...
          'items'=>array(
            ...
            array('label'=>'Registro', 'url'=>array('/clientes/create')),
...
<?php endif;?>
<!--Mesanejes de error en sesion-->
<?php if(($msgs=Yii::app()->user->getFlashes())!==null):?>
  <div class="container">
    <div class="row-fluid">
      <div class="span12">    
       <?php foreach($msgs as $type => $message):?>
        <div class="alert alert-<?php echo $type?>-block">
        <button type="button" class="close" data-dismiss="alert">&times;</button>
         <h4><?php echo ucfirst($type)?>!</h4>
     <?php echo $message?>
   </div>
...
<footer class="footer bg-ft clearfix pd4">
 ...
 <section class="footer-credits">
    <div class="container">
        <ul class="clearfix">
            <li>© 2017 Luis Alejandro ROjas Cancino.</li>
            <li><a href="#">Link</a></li>
            <li><a href="#">Link</a></li>
        </ul>
    </div>
